return {
 ...
 signator = {
  ...
  y = 250,
  text = [[
  Hey this is signator 
  this provides signal 
  to the evil ai mechs.
  Remeber! red means false 
  and green means true.
  ]]
 },
 aimachines = {
  x = 500,
  ...
  and win over them. Also 
  remeber red means disabled 
  and green means enabled
  ]]
 },
 and_gate = {
  x = 200,
